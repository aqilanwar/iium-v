  ...
  <div class="container" style="margin-top:150px; min-height:90vh">
    ...
    if (isset($_GET['title'])) {
      if (!empty($_GET['title'])) {
        ...
        if ($_GET['category'] == '1') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_title LIKE '%$title%' ";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '2') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Food And Beverages' AND product_title LIKE '%$title%' ";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '3') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Fashion' AND product_title LIKE '%$title%' ";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '4') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Electronics' AND product_title LIKE '%$title%' ";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '5') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Others' AND product_title LIKE '%$title%' ";
          $result = mysqli_query($sql_connect, $query);
        }
        ...
        if ($_GET['category'] == '1') {
          ...
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Food And Beverages'";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '3') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Fashion'";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '4') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Electronics'";
          $result = mysqli_query($sql_connect, $query);
        } else if ($_GET['category'] == '5') {
          $query = "SELECT * FROM product WHERE type = 'Product' AND product_category = 'Others'";
          $result = mysqli_query($sql_connect, $query);
        }
      }
    } else {
